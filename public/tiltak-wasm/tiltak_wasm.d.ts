...
declare interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb33fe2d4c1abab84: (a: number, b: number, c: number, d: number) => void;
